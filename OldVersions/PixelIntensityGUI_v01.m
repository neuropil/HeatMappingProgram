function varargout = PixelIntensityGUI_v01(varargin)
% PIXELINTENSITYGUI_V01 MATLAB code for PixelIntensityGUI_v01.fig
%      PIXELINTENSITYGUI_V01, by itself, creates a new PIXELINTENSITYGUI_V01 or raises the existing
%      singleton*.
%
%      H = PIXELINTENSITYGUI_V01 returns the handle to a new PIXELINTENSITYGUI_V01 or the handle to
%      the existing singleton*.
%
%      PIXELINTENSITYGUI_V01('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PIXELINTENSITYGUI_V01.M with the given input arguments.
%
%      PIXELINTENSITYGUI_V01('Property','Value',...) creates a new PIXELINTENSITYGUI_V01 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before PixelIntensityGUI_v01_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to PixelIntensityGUI_v01_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help PixelIntensityGUI_v01

% Last Modified by GUIDE v2.5 11-Nov-2013 19:49:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @PixelIntensityGUI_v01_OpeningFcn, ...
                   'gui_OutputFcn',  @PixelIntensityGUI_v01_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before PixelIntensityGUI_v01 is made visible.
function PixelIntensityGUI_v01_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to PixelIntensityGUI_v01 (see VARARGIN)

% Choose default command line output for PixelIntensityGUI_v01
...
% UIWAIT makes PixelIntensityGUI_v01 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = PixelIntensityGUI_v01_OutputFcn(hObject, eventdata, handles) 
